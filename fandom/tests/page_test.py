...
class TestPage(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.anby_demara = fandom.page(
            wiki="zenless-zone-zero", title="Anby Demara/Lore"
        )
    ...
    def test_url(self):
        ...
        self.assertEqual(
            self.moisture_farm.url, "https://starwars.fandom.com/en/wiki/Moisture_farm"
        )
    ...
    def test_content(self):
        ...
        self.assertIsInstance(self.anby_demara.content, dict)
    ...
    def test_section(self):
        ...
        self.assertEqual(
            self.Boba_Fett.section("sexual encounter with the sarlacc"), None
        )
